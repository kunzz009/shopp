...
<%--				<input id="submit" type="submit" value="QUAY LẠI TRANG CHỦ ">--%>
				<button type="button" class="btn btn-success"><a href="<c:url value="/"/> " style="color: white;">QUAY LẠI TRANG CHỦ</a></button>
			</form>

			<!-- copyright -->
			<div class="colorlibcopy-agile">
				<p>© 2021 All rights reserved | Design by CHU TÙNG LÂM </p>
			</div>
		</div>
	</div>
